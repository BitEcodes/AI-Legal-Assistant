...
const CourseCard = ({ course }) => (
  <Link to={createPageUrl(`CourseDetail?id=${course.id}`)} className="block hover:no-underline">
...
export default function Course() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 mt-10">
      <h1 className="text-3xl font-bold text-center">Legal Awareness Courses</h1>
